...
IBGC's Consumer Cash Habits in India study evaluated the prevalence and level of transit costs for cash access. All travel costs were recorded in that interview; regardless of whether they were incremental or incidental to obtaining cash. Transit costs, $C_{trans}$, are a simple product of transit cost incidence, $\zeta$, transit fee level, $\nu$, and cash transactions $X_C$. 
...
India is the only market where we have direct observations of transit costs and prices. So we take the transit incidence in India, $\zeta_I$,  and adjust by the ratio $\xi$ that measures rural access relative to India's. The higher is $\xi$, the lower is the share of the population that has access to a road (by the World Bank definition).

$$\xi = \frac{RAI_I}{RAI} $$


Similarly we adjust India's measure of transit prices, $\eta_I$, by the ratio of PPP price levels in India to the reporting country, $\pi$. The higher is $\pi$, the lower are prices in the reporting country.
...
$$
C_{trans} = \left( \zeta_I \xi \right) \left( \eta_I \pi \right) X_{Cash}
$$
